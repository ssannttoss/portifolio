...
class LogEntry {
    ...
    public String toString() {
        ...
        return String.format("%2$s%1$s%5$s%1$s%3$s%1$s%4$s", SPLIT, mLevel.getCode(), DateTimeUtil.parseDateToString(mDate,
                DateTimeUtil.PATTERN_DATE_TIME_DB), mText.replace("\n", "<br>"), mNomeClasse);
    }
}
